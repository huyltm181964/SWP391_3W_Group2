const Footer = () => {
	return (
		<footer class='flex flex-col items-center bg-blue-gray-500 text-center text-surface dark:bg-neutral-700 dark:text-white'>
			<div class='container pt-9'>
				<div class='mb-6 flex justify-center space-x-2 text-cyan-50'>
					<a
						href='#!'
						type='button'
			...
			<div class='w-full bg-black/5 p-4 text-center text-cyan-50'>
				© 2024 Copyright: Shoes store
			</div>
		</footer>
	)
}
